...
@section('userContent')
    <div class="container mx-auto px-6 py-10">
        ...
        <div class="relative mt-5 h-[200px] flex flex-col justify-center items-center text-center bg-cover bg-center rounded-lg shadow-md"
            style="background-image: url('{{ asset('/front/images/people-discuss-research.jpg') }}');">
        ...
        <section class="my-12 flex flex-col lg:flex-row items-center gap-10">
            ...
            <div class="lg:w-1/2">
                <img src="{{ asset('/backend/about-banner.jpg') }}" alt="Mission Image" class="w-full rounded-lg shadow-lg">
            </div>
        </section>
        ...
        <section class="py-12 bg-gradient-to-r from-blue-700 to-blue-500 text-white rounded-lg shadow-lg">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 px-6">
                <div class="p-6 text-center bg-white bg-opacity-20 rounded-lg shadow-md">
                    <h3 class="text-lg font-semibold">Information Technology & Management</h3>
                </div>
                <div class="p-6 text-center bg-white bg-opacity-20 rounded-lg shadow-md">
                    <h3 class="text-lg font-semibold">Computing, Machine Learning & AI</h3>
                </div>
                <div class="p-6 text-center bg-white bg-opacity-20 rounded-lg shadow-md">
                    <h3 class="text-lg font-semibold">Business Management & Social Development</h3>
                </div>
                <div class="p-6 text-center bg-white bg-opacity-20 rounded-lg shadow-md">
                    <h3 class="text-lg font-semibold">Entrepreneurship & Marketing</h3>
                </div>
                <div class="p-6 text-center bg-white bg-opacity-20 rounded-lg shadow-md">
                    <h3 class="text-lg font-semibold">Internet Security & Protocols</h3>
                </div>
                <div class="p-6 text-center bg-white bg-opacity-20 rounded-lg shadow-md">
                    <h3 class="text-lg font-semibold">Banking, Finance & Leadership</h3>
                </div>
            </div>
        </section>
        ...
        <section class="py-12">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 px-6">
                <div class="p-6 text-center bg-blue-100 rounded-lg shadow-md">
                    <img src="{{ asset('/front/images/s3.png') }}" class="mx-auto mb-4 w-24 h-24 rounded-full shadow-lg">
        ...
        <section class="py-12 bg-gray-200 rounded-lg shadow-lg">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 px-6">
                <div class="p-6 bg-white rounded-lg shadow-md">
                    <img src="{{ asset('/front/images/papers/Journal-1.png') }}" class="w-full rounded-md shadow-md mb-4">
                ...
                <div class="p-6 bg-white rounded-lg shadow-md">
                    <img src="{{ asset('/front/images/papers/Journal-2.png') }}" class="w-full rounded-md shadow-md mb-4">
                ...
                <div class="p-6 bg-white rounded-lg shadow-md">
                    <img src="{{ asset('/front/images/papers/Journal-3.png') }}" class="w-full rounded-md shadow-md mb-4">
