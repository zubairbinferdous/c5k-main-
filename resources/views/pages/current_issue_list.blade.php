                        ...
                        <div class="d-flex justify-content-lg-between  flex-row flex-lg-col">
                            ...
                            <div class=" d-flex justify-content-end align-items-end">
                               <div>
                                    ...
                                    <p>The article was first published Online on <span>{{ \Carbon\Carbon::parse($issue->online)->format('d F, Y') }}</span></p>
                         ...
                         <div class="d-flex gap-2 justify-content-end align-items-end">
                                <div>
                                    {{-- <a href="{{ url('/pdf_view_journal') }}?file={{ $issue->pdf_file }}" class="btn  btn-download1 mr-2 ">
                                    View PDF
                                </a> --}}
                                @if (!empty($issue->pdf_file))

                                <a href="{{ route('download_pdf', ['file' => $issue->pdf_file]) }}" class="btn  btn-download1 mr-2 cursor-pointer"
                                    >
                                     Download PDF
                                 </a>
                                 @endif
                            ...
                            <div>
                                <a href="#" target="_blank" class="btn btn-download cursor-pointer">
                                    Article HTML
                                </a>
                            </div>
                            {{-- <div>
                                <a href="{{ route('article.view', ['filename' => basename($issue->article_html)]) }}" target="_blank" class="btn btn-download">
                                    Article HTML
                                </a>
                            </div> --}}
