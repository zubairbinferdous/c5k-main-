        ...
        <a class="nav-link text-white text-center" id="related-tab" data-toggle="tab" href="#related" role="tab">Related</a>
                ...
                <div class="tab-content mt-3" id="issueTabsContent">
                    <div class="tab-pane fade show active" id="about" role="tabpanel">
                        <div class="mb-4">
                            <a href="{{ route('download_pdf', ['file' => $issuDetails->file_path]) }}"  class="btn download1 w-100 text-left py-3 mb-3">
                            ...
                            <div>
                                <a href="#" target="_blank" class="btn download2 w-100 text-left py-3 cursor-pointer">
                                    <i class="bi bi-file-text mr-2"></i>
                                    Article HTML
                                </a>
                            </div>
