...
<style>
    ...
    .button-container button::after {
        ...
        height: 0;
        border-style: solid;
        border-width: 50px 20px 0 40px;
        /* Triangle dimensions */
        border-color: red transparent transparent transparent;
        /* Triangle color matching the button */
    }
    ...
    .publication-content {
        flex: 0 0 100%;
        /* Full width for text on large screens */
    }
    ...
    @media (max-width: 768px) {
        ...
        .content-section {
            flex: 1;
            /* Both take equal width when stacked */
        }
    ...
    .custom-prev {
        left: -2%;
        color: #0b50a1 !important;
        /* This won't affect the icons directly */
    }
    ...
    .carousel-control-next-icon {
        background-color: #0b50a1 !important;
...
<body>
                        ...
                        <div class="row ml-3">
                            <div class="col-md-6 col-lg-6 col-sm-12">
                                ...
                                <div class="d-flex mt-5">
                                    <a href="#"><button type="button" class="btn btn-lg mr-4 btn-warning">Sign
                                            in</button></a>
                                    <a href="#"><button type="button" class="btn btn-lg btn-success">Join
                                            C5K</button></a>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-6 col-sm-12 d-lg-block d-none">
                                <img src="public/front/images/confirence/slide4.svg" class="img-fluid"
                                    alt="Slide Image">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-center ml-5">
                            <div class="col-md-6 col-lg-6 col-sm-12 text-md-left text-center">
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-2 d-flex align-items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            fill="gold" class="mr-2" viewBox="0 0 16 16">
                                            <path
                                                d="M8 0a8 8 0 1 0 8 8A8 8 0 0 0 8 0zM5.5 4.5a.5.5 0 0 1 .5.5v1h4V5a.5.5 0 0 1 1 0v1a2 2 0 0 1-2 2h-2v2h3a.5.5 0 0 1 0 1h-3v1a.5.5 0 0 1-1 0v-1H5.5a.5.5 0 0 1 0-1H7v-2H5a2 2 0 0 1-2-2V5a.5.5 0 0 1 1 0v1a1 1 0 0 0 1 1h2V5a.5.5 0 0 1 .5-.5z" />
                                        </svg>
                                        Affordable fees for authors
                                    </li>
                                    <li class="mb-2 d-flex align-items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            fill="blue" class="mr-2" viewBox="0 0 16 16">
                                            <path
                                                d="M8 0C3.589 0 0 3.589 0 8s3.589 8 8 8 8-3.589 8-8-3.589-8-8-8zM6.27 10.219L2.5 6.719V10h-1V5.719l3.77 3.5L10.5 5.27V10h1V4.5H9.5l-3.23 3.219z" />
                                        </svg>
                                        Quality scientific publishing
                                    </li>
                                    <li class="mb-2 d-flex align-items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            fill="green" class="mr-2" viewBox="0 0 16 16">
                                            <path
                                                d="M5 10.732A2 2 0 1 0 6 12V4H4v8c-.29.417-.598.776-1 .732a2 2 0 1 0 2 2V2h2v12a2 2 0 1 0 2-2V8H6v2.732z" />
                                        </svg>
                                        15% overall royalty payments
                                    </li>
                                    <li class="mb-2 d-flex align-items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            fill="skyblue" class="mr-2" viewBox="0 0 16 16">
                                            <path
                                                d="M2 3.5a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-.5.5H7.707l.647.646a.5.5 0 0 1 0 .708L7 9.207l-.646-.647a.5.5 0 0 1 0-.708L7.707 7H2.5a.5.5 0 0 1-.5-.5v-3z" />
                                            <path
                                                d="M8.5 4a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zM10.5 15a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zM2.5 15a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z" />
                                        </svg>
                                        Distribution over 40 countries
                                    </li>
                                    <li class="d-flex align-items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            fill="red" class="mr-2" viewBox="0 0 16 16">
                                ...
                                <div class="d-flex justify-content-center justify-content-md-start mt-4">
                                    <a href="#"><button type="button" class="btn btn-lg btn-warning mr-3">Sign
                                            in</button></a>
                                    <a href="#"><button type="button" class="btn btn-lg btn-success">Join
                                            C5K</button></a>
                                </div>
                            ...
                            <div class="col-md-6 col-lg-6 col-sm-12 text-center d-none d-lg-block">
                                <img src="public/front/images/confirence/slide5.svg" class="img-fluid"
                                    alt="Slide Image">
                            </div>
                        </div>
                    </div>
    ...
    <section class="container mx-auto py-12 px-6 text-center">
        <h3 class="text-3xl font-bold">Find Thesis by Category</h3>
        <p class="text-gray-600">Explore books categorized for your interests.</p>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-6">
            @foreach ($categories as $category)
                @php
                    $colors = ['bg-blue-500', 'bg-green-500', 'bg-yellow-500', 'bg-red-500', 'bg-indigo-500'];
                    $color = $colors[$loop->index % count($colors)];
                @endphp
                <a href="{{ route('thesis.category', $category->id) }}"
                    class="text-white text-center py-6 px-4 rounded-lg shadow-md {{ $color }} hover:opacity-80">
    ...
    <section class="desirtation-about py-5"
                ...
                <div id="bookpaper" class="carousel slide" data-ride="carousel" data-interval="2000">
                    ...
                    <ol class="carousel-indicators mt-4">
                        @foreach ($books->chunk(3) as $index => $chunk)
                            <li data-target="#bookpaper" data-slide-to="{{ $index }}"
    ...
    <div class="d-flex justify-content-center align-items-center py-4 ">
        <a href="{{ route('thesis.index') }}" class="bg-primary text-white py-2 px-4 shadow"
        ...
        <div class="row gap-4 d-flex justify-content-center">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="service-card">
                    <div class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#007bff" width="48"
                            height="48">
                            <path
                    ...
                    <p>With easy steps and expert advice, publish your work online. Benefit from high-quality editing
                        and personalized assistance tailored to your specific needs and requirements. Achieve your
                        creative goals with confidence.</p>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="service-card">
                    ...
                    <p>Our publishing service ensures your thesis gets international recognition. Reach a wider audience
                        and maximize its impact with our comprehensive worldwide marketing strategy.</p>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="service-card">
                    ...
                    <p>Our committed group of experts provides comprehensive support throughout the entire thesis
                        publishing process. Trust us to help you achieve your academic goals with confidence.</p>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="service-card">
                    ...
                    <p>We publish your thesis using state-of-the-art print-on-demand technology, minimizing waste and
                        reducing our carbon footprint. Our service is cost-effective and eco-friendly.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div>
            ...
            <div class="step-cards row">
                ...
                <div class="step-card col-lg-3 col-md-6 col-sm-12">
                    ...
                    <p>Whether you have a complete manuscript or just a draft, we are eager to provide constructive
                        feedback within a few days—no obligations, no hassle.</p>
                </div>
                ...
                <div class="step-card col-lg-3 col-md-6 col-sm-12">
                    ...
                    <p>Every great work begins with refinement. In this phase of review and revision, we elevate your
                        ideas, ensuring they shine with clarity and precision.</p>
                </div>
                ...
                <div class="step-card col-lg-3 col-md-6 col-sm-12">
                    ...
                    <p>Your thesis is evidence of your diligence and commitment. Let us help you perfect it, ensuring
                        that every argument is compelling and every detail is polished to perfection.</p>
                </div>
                ...
                <div class="step-card col-lg-3 col-md-6 col-sm-12">
                    ...
                    <p>Transform your research into a published masterpiece! With us, your thesis will reach readers
                        around the globe and have a global influence.</p>
                </div>
            </div>
        </div>
                    ...
                    <div class="card text-center" style="border:none; background-color:#F7F8F9;">
                        <div class="card-body d-flex flex-column align-items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56"
                                fill="currentColor" class="mb-3" viewBox="0 0 16 16">
                                <path
                                    d="M4 1.5A1.5 1.5 0 0 0 2.5 3v10A1.5 1.5 0 0 0 4 14.5h9A1.5 1.5 0 0 0 14.5 13v-2h-1v2a.5.5 0 0 1-.5.5H4a.5.5 0 0 1-.5-.5V3a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 .5.5v2h1V3A1.5 1.5 0 0 0 13 1.5H4z" />
                                <path
                                    d="M6 4.5A.5.5 0 0 1 6.5 4h4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-.5.5h-4a.5.5 0 0 1-.5-.5v-7z" />
                            </svg>
                            <h4>Publish Your Thesis</h4>
                            <p class="mt-3">Congratulations! Let’s start with what it costs, what you need, and what
                                we offer.</p>
                    ...
                    <div class="card text-center" style="border:none; background-color:#F7F8F9;">
                        <div class="card-body d-flex flex-column align-items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56"
                                fill="currentColor" class="mb-3" viewBox="0 0 16 16">
                                <path
                                    d="M9 0a2 2 0 0 1 2 2v6.293l1.854-1.854a.5.5 0 0 1 .708.708l-3 3a.5.5 0 0 1-.708 0l-3-3a.5.5 0 1 1 .708-.708L8 8.293V2a2 2 0 0 1 2-2z" />
                                <path
                                    d="M9 15a2 2 0 0 1-2-2V6.707l-1.854 1.853a.5.5 0 1 1-.708-.707l3-3a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1-.708.707L9 6.707V13a2 2 0 0 1-2 2z" />
                            </svg>
                            <h4>About Self-Publishing</h4>
                            <p class="mt-3">Hardcover, paperback, ebooks, and global book distribution are our
                                specialties!</p>
                            <button type="button" class="btn btn-info btn-rounded">Get Started</button>
                        </div>
                    </div>
                    ...
                    <div class="card text-center" style="border:none; background-color:#F7F8F9;">
                        <div class="card-body d-flex flex-column align-items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56"
                                fill="currentColor" class="mb-3" viewBox="0 0 16 16">
                                <path
                                    d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-3.5l-2 2-.5-2H4a2 2 0 0 1-2-2V2z" />
    ...
    <section class="container my-5 publication-section d-flex">
        ...
        <div class="publication-image" style="overflow:hidden; margin-right: 20px;margin-top:10px;">
            <img src="{{ asset('public/backend/journal/thesisImage.png') }}" alt="Dissertation 6"
        ...
        <div class="publication-content" style="margin-top: 0; padding-top: 0;">
            ...
            <p class="text-justify" style="margin-top: 0;">
                To provide authors and research scholars with a worldwide and extensive platform to showcase their
                unique work, C5KTP offers book or dissertation publication services. Publishing your book or
                dissertation as a book monograph can help you advance your understanding of the topic, influence your
                discipline, and start your academic career.
            </p>
            <p class="text-justify">
                Each author whose book is published will have a permanent page on our website with their name,
                biographical information, and the ISBN and DOI number provided. Additionally, authors can make
                adjustments to their webpages post-publication.
            </p>
