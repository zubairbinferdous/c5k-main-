        ...
        <section class="mt-12">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <p><strong>Conference Name:</strong> [Conference Name]</p>
                        <p><strong>Date:</strong> [Insert Date]</p>
                        <p><strong>Location:</strong> [Insert Location or Virtual Link]</p>
                    </div>
                    <div>
                        <p><strong>Theme:</strong> [Highlight the main theme of the conference]</p>
                        <p><strong>Keynote Speakers:</strong> [List of keynote speakers]</p>
                        <p><strong>Sessions:</strong> [Description of workshops and discussions]</p>
                    </div>
                </div>
            </div>
        </section>
