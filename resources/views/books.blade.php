<title>C5k | dissertation/books</title>
...
<section class="mt-2 book-banner" style="background-color:#EFFAFB;">
        ...
        <div class="carousel-item active">
          <div class="row ml-3">
            <div class="col-md-6 col-lg-6 col-sm-12">
              <h1>Publish Book on Your Way.</h1>
...
<section class="container py-4">
  <h3 class="text-center">Find Book by Category</h3>
                        ...
                        <div class="row">
                            @foreach ($chunk as $book)
                                <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
                                    <div class="card">
                                        <img src="{{ asset('public/backend/books/' . $book->book_img) }}" class="card-img-top" alt="Book Image">
                                    </div>
                                </div>
                            @endforeach
                        </div>
...
<a href="{{route('bookList.index')}}" class="bg-primary text-white py-2 px-4 shadow"  style="text-decoration:none">
    All Books
    ...
    <div class="row gap-4 d-flex justify-content-center">
      ...
      <div class="col-lg-3 col-md-6">
        <div class="service-card">
          ...
          <h3>Over the World book Publishing Service</h3>
      ...
      <div class="col-lg-3 col-md-6">
        <div class="service-card">
          ...
          <p>Our publishing service ensures your book gets international recognition. Reach a wider audience and maximize its impact with our comprehensive worldwide marketing strategy.</p>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-6">
        <div class="service-card">
          ...
          <h3>Publish Your book with Expert Assistance</h3>
          <p>Our committed group of experts provides comprehensive support throughout the entire book publishing process. Trust us to help you achieve your academic goals with confidence.</p>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-6">
        <div class="service-card">
          ...
          <p>We publish your book using state-of-the-art print-on-demand technology, minimizing waste and reducing our carbon footprint. Our service is cost-effective and eco-friendly.</p>
        </div>
      </div>
    </div>
  </section>
 <section class="container step-section py-5">
    <div>
      <div class="text-center my-4 pb-4">
        <h2>Our book Publishing Procedure is Easy and Quicker</h2>
      ...
      <div class="step-cards row">
        ...
        <div class="step-card col-lg-3 col-md-6 col-sm-12">
          <span>3</span>
          <h3>Proof of book</h3>
          <p>Your book is evidence of your diligence and commitment. Let us help you perfect it, ensuring that every argument is compelling and every detail is polished to perfection.</p>
        </div>
        ...
        <div class="step-card col-lg-3 col-md-6 col-sm-12">
          ...
          <p>Transform your research into a published masterpiece! With us, your book will reach readers around the globe and have a global influence.</p>
        </div>
      </div>
    </div>
    ...
    <div class="container">
        <div class="text-center py-3 academic-title">
              <h3 class="mb-3">Publish Your Book</h3>
            ...
            <div class="col-lg-4 col-md-6 d-flex justify-content-center">
                <div class="card text-center" style="border:none; background-color:#F7F8F9;">
                    <div class="card-body d-flex flex-column align-items-center">
                        ...
                        <h4>Share and Sell Your book</h4>
...
<section class="container my-5 statistics-container">
  <h3 class="text-center">Our book Publishing Statistics</h3>
...
<section class="container my-5 publication-section d-flex">
  ...
  <div class="publication-image" style="overflow:hidden; margin-right: 20px;margin-top:10px;">
    <img src="{{ asset('public/backend/journal/bookImage.jpg') }}" alt="Dissertation 6" style="display: block; max-width: 100%; height: auto;">
  </div>
...
<!--    <h2 class="text-center py-4">Your Dissertation/book Publish on Your Way!</h2>-->
<!--    <p></p>-->
<!--</section>-->
